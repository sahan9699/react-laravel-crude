...
const  PostAll = () => {
    ...
    const  handleCategoryChange  = (category_id) => {
        setQuery({...query ,page: 1, category_id: category_id});
    }
   ...
   const fetchPosts = () => {
    ...
    return (
        <div className="overflow-hidden overflow-x-auto p-6 bg-white border-gray-200">
            <select onChange={(event) => handleCategoryChange(event.target.value)} className="form-select mb-4" aria-label="Default select example">
